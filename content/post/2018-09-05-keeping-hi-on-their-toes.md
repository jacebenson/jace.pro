...
```js
    ...
    jQuery(document).ready(function(){
        ...
        var updatePollTimeinMS = 30000;
        var keepPolling = false; // polls every so many seconds
        ...
        function checkUnread() {
            ...
            query+= 'active=true';
            query+= '&sysparm_fields=number,short_description,sys_id,sys_class_name,sys_updated_by';
            var xhr = new XMLHttpRequest();
