...
[getRecordDisplayValues(object data, GlideRecord, string fields)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getRecordDispValues_O_GR_S)
...
[getRecordElements(object data, GlideRecord, string fields)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getRecordElements_O_GR_S)
...
[getRecordValues(object data, GlideRecord, string fields)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getRecordValues_O_GR_S)
...
[getStream(string table, string sys\_id)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getStream_S_S)
...
[getValue(string field)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getValue_S)
...
[getWidget(string sys\_id/widget-id, object options)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getWidget_S__O)
...
[getKBCount(string sys\_id)](//.service-now.com/sp_widget_list.do?sysparm_query=sys_id=ee307070d7201200a9addd173e24d4da)
...
[getKBCategoryArticles(string sys\_id)](//.service-now.com/sp_widget_list.do?sysparm_query=sys_id=122ac7f0d7101200a9addd173e24d411)
...
[getKBTopicArticles(string topic)](//.service-now.com/sp_widget_list.do?sysparm_query=sys_id=35c51f56d7f33100a9ad1e173e24d4b1)
...
[getKBTopCategoryID(string sys\_id)](//.service-now.com/sp_widget_list.do?sysparm_query=sys_id=c254be50d7201200a9addd173e24d410)
...
[getKBSiblingCategories(string sys\_id)](//.service-now.com/sp_widget_list.do?sysparm_query=sys_id=ee307070d7201200a9addd173e24d4da)
...
[buildThemeVariableModel(string sys\_id, array)](//.service-now.com/sp_widget_list.do?sysparm_query=id=widget-portal-config)
...
[getFilterBreadcrumbs(string table, string, query, null)](//.service-now.com/sp_widget_list.do?sysparm_query=id=widget-filter-breadcrumbs)
...
[saveRecord(string table, string sys\_id, array fields)](.service-now.com/sp_widget_list.do?sysparm_query=id=widget-form)
