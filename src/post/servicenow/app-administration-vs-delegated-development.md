...
permalink: /app-administration-vs-delegated-development/
description: Application Administration and Delegated Development both touch
  scoped applications and how you and your collogues can work together.  What
  are they and when should you use one over the other?
author: Jace Benson
image: /static/img/application-adminstration.png
date: 2024-12-03T06:34:04.918Z
draft: false
stage: published
prism: false
---
...
3. Click on that, a Modal will appear with a invite field, and level.
   ...
   ![](/static/img/pasted-image-20241203001149.png)
...
9. Stop impersonating them and go back to where you invited them, that modal.  You'll see they are listed as a collaborator, go ahead and change their access.
   ...
   ![](/static/img/pasted-image-20241203001230.png)

10. See the options, there's a "Allow Scripting" near the bottom.


       ![](/static/img/pasted-image-20241203001310.png)
