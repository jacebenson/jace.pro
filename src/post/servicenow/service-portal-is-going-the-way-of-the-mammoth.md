...
permalink: /service-portal-is-going-the-way-of-the-mammoth/
author: Jace Benson
date: 2019-10-15T03:34:40.680Z
draft: false
prism: false
---
<!--StartFragment-->
...
![](/static/img/sp-mammoth-01.png)

![](/static/img/sp-mammoth-02.png)
...
* Experience Components - These are a UI and effects to connect to the platform API
  ...
  ![](/static/img/sp-mammoth-03.png)
* Base Components - UI only building blocks

  ![](/static/img/sp-mammoth-04.png)

  ![](/static/img/sp-mammoth-05.png)


* How does it work together?

  ![](/static/img/sp-mammoth-06.png)
