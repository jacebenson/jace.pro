...
permalink: /post/2019-09-06-no-code-date-validations/
author: Jace Benson
date: 2019-09-07T00:44:56.153Z
draft: false
prism: false
---
<!--StartFragment-->
...
![](/static/img/no-code-date-validation-1-ui-policy.png)

<!--StartFragment-->

1. Add a UI Policy action for the field `Date` and check the `clear value` checkbox.

   ![](/static/img/no-code-date-validation-2-ui-policy-action.png)
2. Update the variable `Date` to have `Example text` of "Date cannot be in the past."

   ![](/static/img/no-code-date-validation-3-update-variable.png)
