---
title: CloudFlare Pages, Netlify, Vercel, Github Pages, and Gitlab Pages. Where
  to host for free?
permalink: /post/2020-12-17-cloudflare-pages-netlify-zeit-github-pages-and-gitlab-pages-where-to-host/
author: Jace Benson
date: 2020-12-17T07:17:07.359Z
draft: false
prism: false
---
<!--StartFragment-->
  ...
  <div class="vendor-card">
    ...
    <div class="nutrition-facts">
      ...
      <div class="feature-group">
        <h5>Build & Deploy</h5>
        {% assign build_features = "Build Limit,Build Time to Error,Build Time per Month,Concurrent Builds,Deploy Limits" | split: "," %}
        {% for feature in ssg.features %}
          {% if build_features contains feature[0] %}
      ...
      <div class="feature-group">
        <h5>Core Features</h5>
        {% assign feature_features = "Deploy Previews,Serverless Functions,Invocations/Month,Duration Allowed,DNS Management,HTTPS Available" | split: "," %}
        {% for feature in ssg.features %}
          {% if feature_features contains feature[0] %}
      ...
      <div class="feature-group">
        <h5>Usage Limits</h5>
        {% assign limit_features = "Bandwidth/Month,Site Limit,Default URL" | split: "," %}
        {% for feature in ssg.features %}
          {% if limit_features contains feature[0] %}
      ...
      <div class="feature-group">
        <h5>Collaboration</h5>
        {% assign team_features = "# of Team Members,Team SSO Available,# of Users,User SSO Available" | split: "," %}
        {% for feature in ssg.features %}
          {% if team_features contains feature[0] %}
      ...
      <div class="feature-group">
        <h5>Extras</h5>
        {% assign extra_features = "Form Submissions/Month,Analytics,Split A/B Testing,Allowed for Business Use" | split: "," %}
        {% for feature in ssg.features %}
          {% if extra_features contains feature[0] %}
