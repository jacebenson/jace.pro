...
permalink: /the-good-and-bad-about-openai-and-chatgpt-around-servicenow/
description: Let me take you on my journey to understanding Artificial
  Intelligence (AI) and Machine Learning (ML). From my first introduction to
  ServiceNow's offering, to understanding the concept of assigning weights to
  recognize images, to learning about OpenAI's offerings, I document my steps in
...
author: Jace Benson
image: /static/img/machine-learning-g6b60ac336_1920.jpg
imageAltText: 'A typewriter with the text "Machine Learning" on the
  sheet.  Image by Markus Winkler from Pixabay '
date: 2022-12-23T22:18:51.003Z
draft: false
stage: published
prism: false
---
