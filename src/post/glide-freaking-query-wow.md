...
permalink: /post/2020-05-24-glide-freaking-query-wow/
author: Jace Benson
date: 2020-05-24T06:00:15.216Z
draft: false
prism: false
---
<!--StartFragment-->
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![](/static/img/fieldcheckinggr.png)](/static/img/fieldcheckinggr.png) | [![](/static/img/fieldcheckinggq.png)](/static/img/fieldcheckinggq.png) |
...
| GlideRecord Example                                                                                                                                                   | GlideQuery Example                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![](/static/img/choicecheckinggr.png)](/static/img/choicecheckinggr.png) | [![](/static/img/choicecheckinggq.png)](/static/img/choicecheckinggq.png) |
...
| GlideRecord Example                                                                                                                                                           | GlideQuery Example                                                                                                                                                            |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![](/static/img/typecheckinggr.png)](/static/img/typecheckinggr.png)             | [![](/static/img/typecheckinggq.png)](/static/img/typecheckinggq.png)             |
| [![](/static/img/typecheckinggrupdate.png)](/static/img/typecheckinggrupdate.png) | [![](/static/img/typecheckinggqupdate.png)](/static/img/typecheckinggqupdate.png) |
...
| GlideRecord Example                                                                                                                                                                       | GlideQuery Example                                                                                                                                                                          |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![](/static/img/bejavascriptstringlytyped.png)](/static/img/bejavascriptstringlytyped.png)   | [![](/static/img/bejavascriptstringlytypedgq.png)](/static/img/bejavascriptstringlytypedgq.png) |
| [![](/static/img/bejavascriptstringlytyped2.png)](/static/img/bejavascriptstringlytyped2.png) |                                                                                                                                                                                             |
| [![](/static/img/bejavascriptstringlytyped3.png)](/static/img/bejavascriptstringlytyped3.png) |                                                                                                                                                                                             |

### [Stacktraces](#stacktraces)

| GlideRecord Example                                                                                                                                           | GlideQuery Example                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![](/static/img/stacktracegr.png)](/static/img/stacktracegr.png) | [![](/static/img/stacktracegq.png)](/static/img/stacktracegq.png) |
...
| GlideRecord Example                                                                                                                                                   | GlideQuery Example                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![](/static/img/complexqueriesgr.png)](/static/img/complexqueriesgr.png) | [![](/static/img/complexqueriesgq.png)](/static/img/complexqueriesgq.png) |
...
[![](/static/img/maponstream.png)](/static/img/maponstream.png)[![](/static/img/someonstream.png)](/static/img/someonstream.png)[![](/static/img/everyonstream.png)](/static/img/everyonstream.png)

### [Aggregation](#aggregation)

Examples;

[![](/static/img/aggregate1.png)](/static/img/aggregate1.png)[![](/static/img/aggregate2.png)](/static/img/aggregate2.png)[![](/static/img/aggregate3.png)](/static/img/aggregate3.png)

### [Insert](#insert)

[![](/static/img/insert.png)](/static/img/insert.png)

### [Delete](#delete)

[![](/static/img/delete.png)](/static/img/delete.png)

### [Update](#update)

[![](/static/img/updateone.png)](/static/img/updateone.png)[![](/static/img/updatemultiple.png)](/static/img/updatemultiple.png)
...
[![](/static/img/flagscurrency.png)](/static/img/flagscurrency.png)
...
[![](/static/img/commonperfmistakes.png)](/static/img/commonperfmistakes.png)

[![](/static/img/commonperfmistakes2.png)](/static/img/commonperfmistakes2.png)
