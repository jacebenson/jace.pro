...
description: Today I got an email my old VPS host is changing the pricing on
  storage.  I moved a lot of my infrastucture to Hetzner so I thought I'd move
  the s3 object storge today.
date: 2025-12-11
tags: []
---
## What is s3
...
6. It will ask to either be given the credential or get them from an env var.  I chose to give the credientials to it by choosing `1`
7. It will tehn ask for the following;
...
9. It'lls hopw you the settings confirm this `y) Yes this is OK`
