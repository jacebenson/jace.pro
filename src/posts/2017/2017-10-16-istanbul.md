---
title: Istanbul
description: Istanbul release notes and features including the Automated Testing Framework, Email REST API, Script Debugger, and HR Service Management (Scoped).
date: '2017-10-17'
tags:
  - servicenow
redirectFrom:
